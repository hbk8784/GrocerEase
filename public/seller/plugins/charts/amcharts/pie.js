(function() {
    ...
    k.AmSlicedChart = k.Class({
        ...
        clickSlice: function(a, b, c) {
            this.checkTouchDuration(b) && (isNaN(a) || (a = this.chartData[a]),
        ...
        initialStart: function() {
            ...
            a.timeOuts.push(c);
            a.chartCreated ? a.pullSlices(!0) : (a.startSlices(),
            0 < b ? (b = setTimeout(function() {
                a.pullSlices.call(a)
            }, 1200 * b),
            a.timeOuts.push(b)) : a.pullSlices(!0))
        },
        pullSlice: function(a, b, c) {
            ...
            if (c = a.wedge)
                ...
                a.labelSet && a.labelSet.animate({
                    translate: b * a.pullX + "," + b * a.pullY
                }, d, this.pullOutEffect)) : (a.labelSet && a.labelSet.translate(b * a.pullX, b * a.pullY),
        ...
        parseData: function() {
            ...
            if (void 0 !== b) {
                ...
                for (g = 0; g < a.length; g++)
                    c ? h = k.adjustLuminosity(c, g * d / 100) : (h = this.colors[g],
        ...
        animateAgain: function() {
            ...
            for (var b = 0; b < a.chartData.length; b++) {
                ...
                c.started = !1;
                var d = c.wedge;
                d && (d.setAttr("opacity", a.startAlpha),
            ...
            a.timeOuts.push(b)) : a.pullSlices()
        },
    ...
    k.AmPieChart = k.Class({
        ...
        drawChart: function() {
            ...
            if (k.ifArray(a)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    m = f(this.radius, d, g);
                    m || (d = 0 <= w ? d - h - e - 2 * q : d - h - e,
                    g = g - z - n,
                    m = Math.min(d, g),
                    g < d && (m /= 1 - this.angle / 90,
                    m > d && (m = d)),
                    ...
                    for (var E, h = 0; h < a.length; h++)
                        ...
                        !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
                            ...
                            if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
                                ...
                                360 < l && (l -= 360);
                                var t = w;
                                isNaN(e.labelRadius) || (t = e.labelRadius,
                                0 > t && (e.skipTick = !0));
                                ...
                                t = e.labelColor;
                                t || (t = this.color);
                                "" !== l && (l = k.wrappedText(c, l, t, this.fontFamily, this.fontSize, x, !1, this.maxLabelWidth),
                            ...
                            r = f + (m - f) / 2;
                            e.pulled && (r += g);
                            this.accessible && this.accessibleLabel && (D = this.formatString(this.accessibleLabel, e),
        ...
        checkOverlapping: function(a, b, c, d, g) {
            ...
            if (n) {
                ...
                !0 === f && 200 > g && isNaN(b.labelRadius) && (f = b.ty + 3 * b.iy,
                b.ty = f,
        ...
        checkOverlappingReal: function(a, b, c) {
            var d = !1
              , g = a.label
              , f = b.label;
            a.labelQuarter != c || a.hidden || b.hidden || !f || (g = g.getBBox(),
            c = {},
            c.width = g.width,
            c.height = g.height,
            c.y = a.ty,
