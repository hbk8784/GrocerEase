    ...
    d.RadAxis = d.Class({
        construct: function(a) {
            ...
            if (b) {
                ...
                "middle" == a.pointPosition && "circles" != a.gridType && (a.rMultiplier = Math.cos(180 / l * Math.PI / 180),
                z *= a.rMultiplier);
                for (w = 0; w < l; w += a.axisFrequency) {
                    ...
                    0 < m && (t = d.line(b.container, [0, t], [0, q], f, m, c),
                    this.set.push(t),
...
(function() {
    ...
    d.RadItem = d.Class({
        construct: function(a, b, c, f, m, n, e, r) {
            ...
            !0 === e.inside && (G = !0),
            void 0 !== e.boldLabel && (r = e.boldLabel)) : c || (g /= 3,
            q /= 2);
            var I = "end"
              , C = -1;
            G && (I = "start",
