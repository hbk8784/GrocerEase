    ...
    f.AmRectangularChart = f.Class({
        ...
        measureMargins: function() {
            ...
            if (a = this.categoryAxis)
                ...
                f = Math.round(b.t),
                b = Math.round(b.b);
            d.left && e < c && (this.marginLeft = Math.round(-e + c),
            ...
            d.top && f < c + this.titleHeight && (this.marginTop = Math.round(this.marginTop - f + c + this.titleHeight),
        ...
        drawZoomOutButton: function() {
            ...
            if (!a.zbSet) {
                ...
                void 0 !== e && (c = f.text(a.container, e, c, a.fontFamily, d, "start"),
        ...
        drawPlotArea: function() {
            ...
            e.translate(c + a, d + b);
            this.set.push(e);
            0 !== a && 0 !== b && (e = this.plotAreaFillColors,
            "object" == typeof e && (e = e[0]),
            e = f.adjustLuminosity(e, -.15),
            g = f.polygon(this.container, [0, a, g + a, g, 0], [0, b, b, 0, 0], e, l, 1, k, m),
            f.setCN(this, g, "plot-area-bottom"),
            g.translate(c, d + h),
            this.set.push(g),
            a = f.polygon(this.container, [0, 0, a, a, 0], [0, h, h + b, b, 0], e, l, 1, k, m),
        ...
        updateChartCursor: function() {
            var a = this.chartCursor;
            a && (a = f.processObject(a, f.ChartCursor, this.theme),
        ...
        processScrollbars: function() {
            ...
            a && (a = f.processObject(a, f.ChartScrollbar, this.theme),
        ...
        updateChartScrollbar: function(a, b) {
            if (a) {
                ...
                a.x = d - g - f) : (a.y = c - g + e - f,
                a.x = d + h) : b ? (a.y = c + e,
                a.x = d + this.plotAreaWidth + h + f) : (a.y = c + this.plotAreaHeight + f,
                a.x = this.marginLeftReal)
            }
        },
        showZB: function(a) {
...
(function() {
    ...
    f.AmSerialChart = f.Class({
                ...
                if (0 < a.length) {
                    ...
                    for (c = 0; c < a.length; c++)
                        ...
                        b.gridCountReal < d) {
                            ...
                            e += .5);
                            0 <= b.min && 0 > b.min - g * b.step && (e += g,
                            g = 0);
                            0 >= b.max && 0 < b.max + e * b.step && (g += e,
                            e = 0);
        ...
        handleWheelReal: function(a, b) {
            if (!this.wheelBusy) {
                ...
                if (f) {
                    var k = f.mouseX
                      , f = f.mouseY;
                    h != e && (k = this.rotate ? f / this.plotAreaHeight : k / this.plotAreaWidth,
                    h *= k,
                    e *= 1 - k);
                ...
                c = this.lastTime;
                k = this.firstTime;
                0 > a ? d ? (f = this.endTime - this.startTime,
                d = this.startTime + h * g,
                g = this.endTime + e * g,
                0 < e && 0 < h && g >= c && (g = c,
                d = c - f),
                this.zoomToDates(new Date(d), new Date(g))) : (0 < e && 0 < h && this.end >= f - 1 && (h = e = 0),
                d = this.start + h,
                g = this.end + e,
                this.zoomToIndexes(d, g)) : d ? (f = this.endTime - this.startTime,
                d = this.startTime - h * g,
                g = this.endTime - e * g,
                0 < e && 0 < h && d <= k && (d = k,
                g = k + f),
                this.zoomToDates(new Date(d), new Date(g))) : (0 < e && 0 < h && 1 > this.start && (h = e = 0),
                d = this.start - h,
                g = this.end - e,
        ...
        showZB: function() {
            ...
            if (b = this.valueAxes)
                b = b[0],
                isNaN(b.relativeStart) || (0 !== f.roundTo(b.relativeStart, 3) && (a = !0),
            ...
            for (l = 0; l < b; l++) {
                ...
                if ("100%" == k || "regular" == k)
                    ...
                    e = 0; e < c; e++)
                        d = this.graphs[e],
                        d.tcc = 1,
                        d.valueAxis == g && "column" == d.type && (!f && d.stackable && (a++,
                        f = !0),
        ...
        formatString: function(a, b, c) {
            if (b) {
                ...
                if (void 0 !== a) {
                    ...
                    g || (g = this.nf);
                    h = b.graph.valueAxis;
                    (e = h.duration) && !isNaN(b.values.value) && (e = f.formatDuration(b.values.value, e, "", h.durationUnits, h.maxInterval, g),
                    a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), e));
                    "date" == h.type && (h = f.formatDate(new Date(b.values.value), d.dateFormat, this),
                    e = RegExp("\\[\\[value\\]\\]", "g"),
                    a = a.replace(e, h),
        ...
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                a.hZoomEnabled = h,
                a.vZoomEnabled = e) : (a.hLineEnabled = l,
                a.vZoomEnabled = h,
                a.hZoomEnabled = e);
                ...
                a.categoryBalloonEnabled && ((e = b.balloon) || (e = {}),
                e = f.extend(e, this.balloon, !0),
                e.fillColor = d,
                e.balloonColor = d,
                e.fillAlpha = c,
        ...
        handleCursorZoomReal: function(a, b, c, d, g) {
            ...
            f.vZoomEnabled && (e = g.start,
            l = g.end)) : (isNaN(c) || isNaN(d) || this.relativeZoomValueAxes(this.valueAxes, c, d) && this.updateAfterValueZoom(),
            f.hZoomEnabled && (e = g.start,
            l = g.end));
            isNaN(e) || isNaN(l) || (a = this.categoryAxis,
            a.parseDates && !a.equalSpacing ? this.zoomToDates(new Date(e), new Date(l)) : this.zoomToIndexes(e, l))
        },
                    ...
                    if (g = this.chartData[g]) {
                        ...
                        if (b.oneBalloonOnly && b.valueBalloonsEnabled) {
                            ...
                            for (h = d.length - 1; 0 <= h; h--)
                                if (e = d[h],
                                e.balloon.enabled && e.showBalloon && !e.hidden) {
                                    l = e.valueAxis.id;
                        ...
                        if (this.prevCursorItem != g || k != this.prevMostCloseGraph) {
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                k && e != k ? (e.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha),
                                e.balloon.hide(0)) : b.valueBalloonsEnabled ? (e.balloon.showBullet = b.bulletsEnabled,
                                e.balloon.bulletSize = b.bulletSize / 2,
                                a.hideBalloons || (e.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha),
                                e.balloon.set && m.push({
                                    balloon: e.balloon,
        ...
        arrangeBalloons: function(a) {
            ...
            for (c = 0; c < e; c++) {
                ...
                var b = d.bottom
                  , l = d.bottom - d.yPos;
                0 < c && b - l < f + 3 && (d.setBounds(0, f + 3, h, f + l + 3),
                d.restorePrevious(),
                d.draw());
                d.set && d.set.show();
                f = d.bottom
    ...
    f.Cuboid = f.Class({
        ...
        draw: function() {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(e))
                if (isNaN(t))
                    ...
                    D = f.polygon(b, [d, d, d + h, d + h, d], [0, g, g + e, e, 0], q, k, 1, p, 0, u),
                    0 < n && (A = f.line(b, [d, d + h, d + h, d], [0, e, g + e, g], p, n, m, x)),
                    q = f.adjustLuminosity(z, .2),
                    z = f.polygon(b, [0, h, d + h, d, 0], [g, g + e, g + e, g, g], q, k, 1, p, 0, u),
                    ...
                    I = G * t;
                    J = H * t;
                    .1 < G && .1 < G && (w = f.circle(b, G, B, k, m, p, n, !1, H),
                    w.translate(q, N));
                    .1 < I && .1 < I && (z = f.circle(b, I, f.adjustLuminosity(B, .5), k, m, p, n, !1, J),
                    z.translate(O, P))
                }
            k = Q;
            1 > Math.abs(g) && (g = 0);
            1 > Math.abs(d) && (d = 0);
            !isNaN(t) && (0 < Math.abs(h) || 0 < Math.abs(e)) ? (l = [B],
            l = {
                fill: l,
                stroke: p,
                "stroke-width": m,
            ...
            m = " B",
            0 < d && (m = " A"),
            f.VML ? (k += m + Math.round(d - I) + "," + Math.round(g / 2 - J) + "," + Math.round(d + I) + "," + Math.round(g / 2 + J) + "," + d + ",0," + d + "," + g,
            ...
            G = 180),
            b = b.path(k).attr(l),
            b.gradient("linearGradient", [B, f.adjustLuminosity(B, -.3), f.adjustLuminosity(B, -.3), B], G),
            K ? b.translate(h / 2, 0) : b.translate(0, e / 2)) : b = 0 === g ? f.line(b, [0, d], [0, 0], p, n, m, x) : 0 === d ? f.line(b, [0, 0], [0, g], p, n, m, x) : 0 < v ? f.rect(b, d, g, l, k, m, p, n, v, u, x) : f.polygon(b, [0, 0, d, d, 0], [0, g, g, 0, 0], l, k, m, p, n, u, !1, x);
        ...
        updateHeight: function() {
            ...
            window.requestAnimationFrame ? window.requestAnimationFrame(function() {
                ...
                a.updateHeight.call(a)
            }, 1E3 / f.updateRate)) : (a.height(a.rh),
...
(function() {
    ...
    f.CategoryAxis = f.Class({
        ...
        draw: function() {
            ...
            if (f.ifArray(a)) {
                var b, c = this.chart;
                "scrollbar" != this.id ? (f.setCN(c, this.set, "category-axis"),
                f.setCN(c, this.labelsSet, "category-axis"),
                f.setCN(c, this.axisLine.axisSet, "category-axis")) : this.bcn = this.id + "-";
                ...
                if (this.parseDates && !this.equalSpacing)
                    ...
                    this.maxTime = f.resetDateToMin(new Date(this.lastTime + 1.05 * u), this.minPeriod, 1, q).getTime(),
                    this.timeDifference = this.endTime - this.startTime,
                    this.parseDatesDraw();
                else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(e),
                    e < l && (l = e),
                    h += this.start,
                    this.stepWidth = this.getStepWidth(e),
                    0 < l)
                        for (q = Math.floor(e / l),
                        ...
                        this.end - e + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle),
                        b = e; b <= this.end + 2; b++) {
                            l = !1;
                            ...
                            l = 0;
                            "start" == this.gridPosition && (e -= this.cellWidth / 2,
                            l = this.cellWidth / 2);
                            p = !0;
                            E = l;
                        ...
                        for (b = e; b < C; b++)
                            ...
                            this.checkPeriodChange(g, v, t, n) && b >= F) {
                                ...
                                if (b == d && !k || b == l && !m)
                                    n = " ";
                                a ? a = !1 : (w || (u = !1),
                                e - this.previousPos > this.safeDistance * Math.cos(this.labelRotationR * Math.PI / 180) && (this.labelFunction && (n = this.labelFunction(n, new Date(t), this, g, v, E)),
                                this.boldLabels && (u = !0),
                                p = new this.axisItemRenderer(this,e,n,void 0,void 0,void 0,void 0,u),
                                r = p.graphics(),
                                this.pushAxisItem(p),
                                r = r.getBBox().width,
                                f.isModern || (r -= e),
                ...
                for (b = k = 0; b < this.data.length; b++)
                    if (t = this.data[b])
                        ...
                        d = this.cellWidth,
                        "MM" == this.minPeriod && (d = 864E5 * f.daysInMonth(new Date(m)) * this.stepWidth,
                        t.cellWidth = d),
        ...
        formatBalloonText: function(a, b, c) {
            ...
            if (e)
                if (this.parseDates)
                    ...
                    -1 != d.indexOf("fff") && (d = f.formatMilliseconds(d, e.category),
        ...
        adjustBalloonCoordinate: function(a, b) {
            ...
            if (this.stickBalloonToCategory) {
                ...
                if (d) {
                    ...
                    this.rotate ? ("left" == this.position ? (e && (h -= d.width),
                    0 < h && (h = 0)) : 0 > h && (h = 0),
                    d.fixHLine(a, h)) : ("top" == this.position ? (e && (h -= d.height),
                    0 < h && (h = 0)) : 0 > h && (h = 0),
                    d.fixVLine(a, h))
                }
            }
