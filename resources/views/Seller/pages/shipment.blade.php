...
<head>
    ...
    <title>Shipments | Equation - Multipurpose Bootstrap Dashboard Template </title>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/ecommerce/shipments.css">
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive mb-4">
                                    <table id="ecommerce-shipments" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>Customer</th>
