...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/ecommerce/view_payments.css">
    <!--  BEGIN CUSTOM STYLE FILE  -->
</head>
                        ...
                        <div class="payment-top-section">
                            ...
                            <div class="card-section mx-md-auto">
                                <div class="row mt-5">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">
                                        <div class="p-cards">
                                            <i class="ico-c-d-card flaticon-credit-card-1 mb-4"></i>
                                            <h5>$17341</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-5">
                                        <div class="p-cards">
                                            <i class="ico-paypal flaticon-paypal-outlined-logo mb-4"></i>
                                            <h5>$6452</h5>
                                            <h5 class="txt-paypal">Paypal</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
