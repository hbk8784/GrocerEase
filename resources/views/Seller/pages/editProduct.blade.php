    ...
    <header class="header navbar fixed-top navbar-expand-sm">
        ...
        <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                    <a class="dropdown-item" href="javascript:void(0);"><img src="assets/img/de.svg" class="flag-width"
                            alt=""> &#xA0;German</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="assets/img/jp.svg" class="flag-width"
                            alt=""> &#xA0;Japanese</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="assets/img/fr.svg" class="flag-width"
                            alt=""> &#xA0;French</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="assets/img/ru.svg" class="flag-width"
                            alt=""> &#xA0;Russian</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="assets/img/ca.svg" class="flag-width"
                            alt=""> &#xA0;English</a>
                </div>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown message-dropdown ml-lg-4">
                ...
                <div class="dropdown-menu  position-absolute" aria-labelledby="messageDropdown">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="assets/img/profile-9.jpeg"
                        ...
                        <div class="media">
                            <div class="usr-img mr-3">
                                <img class="usr-img rounded-circle" src="assets/img/profile-24.jpeg"
                                    alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                        ...
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="assets/img/profile-3.jpeg"
                                    alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                    ...
                    <a class="footer dropdown-item" href="javascript:void(0);">
                        <div class="btn btn-info mb-3 mr-2 btn-rounded"><i class="flaticon-arrow-right mr-3"></i> View
                            more</div>
                    </a>
                </div>
            </li>
                        ...
                        <div class="notification-list ">
                            ...
                            <div class="notification-item position-relative  mb-3">
                                <div class="c-dropdown text-right">
                                    <span id="c-dropdonbtn" class="c-dropbtn mr-2"><i
                                            class="flaticon-dots"></i></span>
                                ...
                                <p><span class="meta-time">1 minute ago</span> . <span
                                        class="meta-member-notification">4 members</span></p>
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="assets/img/profile-2.jpeg" alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="assets/img/profile-3.jpeg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="assets/img/profile-4.jpeg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="assets/img/profile-5.jpeg" alt="admin-profile">
                                    </li>
                                </ul>
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <div class="c-dropdown text-right">
                                    <span id="c-dropdonbtn2" class="c-dropbtn mr-2"><i
                                            class="flaticon-dots"></i></span>
                                    <div class="c-dropdown-content">
                                        <div class="c-dropdown-item">View</div>
                                        <div class="c-dropdown-item">Delete</div>
                                ...
                                <p><span class="meta-time">5 minutes ago</span> . <span
                                        class="meta-member-notification">5 members</span></p>
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-6.jpeg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-7.jpeg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-8.jpeg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-10.jpeg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-1.jpeg">
                                    </li>
                                </ul>
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <p><span class="meta-time">25 minutes ago</span> . <span
                                        class="meta-member-notification">3 members</span></p>
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-11.jpeg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-16.jpeg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="assets/img/profile-14.jpeg">
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <ul class="navbar-nav flex-row ml-lg-auto">
            ...
            <li class="nav-item dropdown app-dropdown  ml-lg-4 mr-lg-2 order-lg-0 order-2">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="appDropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="accounting_dashboard.html"> <i class="flaticon-chart-line"></i> Accounting
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="stock_market_dashboard.html"> <i class="flaticon-up-chart"></i> Stock Market
                                </a>
                            </li>
                            <li>
                                <a href="cryptocurrency_dashboard.html"> <i class="flaticon-bitcoin-circle"></i>
                                    Cryptocurrency </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="ecommerce"
                        ...
                        <ul class="collapse submenu list-unstyled" id="ui-features" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="#ui-buttons" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Buttons <i class="flaticon-right-arrow"></i> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="ui-buttons"
                            ...
                            <li>
                                <a href="#ui-progress" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Progress Bar <i class="flaticon-right-arrow"></i> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="ui-progress"
                                    data-parent="#ui-features">
                                    <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="forms-bootstrap"
                                    data-parent="#forms">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="forms-input-group"
                                    data-parent="#forms">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="forms-layout"
                                    data-parent="#forms">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="forms-validation"
                                    data-parent="#forms">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="forms-wizard"
                                    data-parent="#forms">
                                    <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="tables" data-parent="#accordionExample">
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="tables-editable"
                                    data-parent="#tables">
                                    <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="charts" data-parent="#accordionExample">
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="chart-amcharts"
                                    data-parent="#charts">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="chart-c3chart"
                                    data-parent="#charts">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="chart-echart"
                                    data-parent="#charts">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="chart-chartist"
                                    data-parent="#charts">
                                    <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="maps" data-parent="#accordionExample">
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="map-googleMaps"
                                    data-parent="#maps">
                                    <li>
                            ...
                            <li>
                                <a href="#map-vMaps" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Vector Maps <i class="flaticon-right-arrow"></i> </a>
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="#user-passRecovery" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Password Recovery <i class="flaticon-right-arrow"></i>
                                </a>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12 text-center">
                                        <div class="product-img">
                                            <img src="assets/img/t-shirt-5.jpg" alt="img">
                                        </div>
                                        <div class="d-flex thumbs-img mt-4 justify-content-center">
                                            <div class="mr-2">
                                                <img src="assets/img/t-shirt-3.jpg" alt="img">
                                            </div>
                                            <div class="mr-2">
                                                <img src="assets/img/t-shirt-2.jpg" alt="img">
                                            </div>
                                            <div class="mr-2">
                                                <img src="assets/img/t-shirt-4.jpg" alt="img">
                                            </div>
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-12">
                                        <form class="form-horizontal" action="#">
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="col-md-5">Attribute Set :</label>
                                                    <div class="col-md-7">
                                                        <select class="form-control form-custom"
                                                            name="attribute_set">
                                                            <option value="opt1">Default</option>
                                                            <option value="opt2">Furniture</option>
                                                            <option value="opt3">Shoes</option>
                                                            <option value="opt4">Cell Phones</option>
                                                            <option value="opt5">Monitors</option>
                                                            <option value="opt6">Clothing</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div><br>
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class="form-control form-custom" name="product">
                                                            <option value="opt1">Simple Product</option>
                                                            <option value="opt2">Configurable Product</option>
                                                            <option value="opt3">Bundle Product</option>
                                                            <option value="opt4">Grouped Product</option>
                                                            <option value="opt5">Virtual Product</option>
                                                            <option value="opt6">Downloadable Product</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div><br>
                                                ...
                                                <div class="card-body">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <div class="form-group cutom-autocomplete mb-4">
                                                            <div class="row">
                                                                <label class="col-md-4">Country of Manufacture
                                                                    :</label>
                                                                <div class="col-md-8">
                                                                    <input id="autocomplete"
                                                                        class="ui-corner-all form-control"
                            ...
                            <div class="d-flex justify-content-between mb-5">
                                ...
                                <div>
                                    <span class="">Today</span> <span
                                        class="notification-count ml-2">12</span>
                                </div>
