                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="direct-chat-messages">
                                                ...
                                                <div class="direct-chat-msg right">
                                                    ...
                                                    <!-- /.direct-chat-infos -->
                                                    <img class="direct-chat-img"
                                                        src="{{ asset('admindist/img/user3-128x128.jpg') }}"
                                                        alt="message user image">
                                                    <!-- /.direct-chat-img -->
                                                    <div class="direct-chat-text">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a
                                                            href="{{ asset('admin/pages/examples/invoice.html') }}">OR9842</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="{{ asset('admin/pages/examples/invoice.html') }}">OR1848</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="{{ asset('admin/pages/examples/invoice.html') }}">OR7429</a>
                                                    </td>
                                                    <td>iPhone 6 Plus</td>
