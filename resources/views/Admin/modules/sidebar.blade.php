    ...
    <div class="sidebar">
       ...
       with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    {{-- <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ asset('admin/pages/tables/simple.htm') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Simple Tables</p>
                            </a>
                        </li>
                ...
                {{-- <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/login.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Login v1</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/register.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Register v1</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/forgot-password.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/recover-password.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/login-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Login v2</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/register-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Register v2</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/forgot-password-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('admin/pages/examples/recover-password-v2.html') }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/pages/examples/legacy-user-menu.html') }}"
                                class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/pages/examples/language-menu.html') }}"
                                class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Language Menu</p>
                            </a>
